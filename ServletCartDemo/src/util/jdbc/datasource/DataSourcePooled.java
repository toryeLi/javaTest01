...
import util.exception.MyOrmException;
 ...
 * 数据源连接池类
 */
public class DataSourcePooled extends util.jdbc.datasource.AbstractDataSourcePooled {
    ...
    private void initial() throws MyOrmException {
        ...
        try {
            //获取注册的驱动
           String aa= DriverInfoEnum.DRIVER_CLASS.getInfo();
